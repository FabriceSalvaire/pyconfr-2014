...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}[yscale=-1]
      ...
      \node [anchor=south,align=center] at (1.5,0) {Evan \& Sutherland\\1970};
      \node at (3,3.25) {\includegraphics[scale=.1]{images/sgi-o2-workstation.jpg}};
      \node [anchor=north,align=center] at (2.5,4.25) {SGI Workstation\\1990-2004};
...
\end{Verbatim}
  ...
  \end{columns}
  \begin{tikzpicture}[remember picture, overlay, mystyle/.style={-latex, line width=1pt}] % run % twice
    \node (o1) at ($(current page.south west) + (5,6)$) {Numpy Array};
    \draw[mystyle] (o1) -- ($(current page.south west) + (8,6)$);
    \draw[mystyle] (o1) -- ($(current page.south west) + (8,4.5)$);
  \end{tikzpicture}
  \note{
    \begin{enumerate}
...
\begin{frame}
  ...
  \begin{center}
    Status de Mesa pour l'Intel HD Graphics (core i3/5/7) \\[.5em]
