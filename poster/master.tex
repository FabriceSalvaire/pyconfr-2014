...
\block{Architecture}{
  ...
  \begin{tikzpicture}[]
    ...
    \node[rotate=5] at (-12,5) {\includegraphics[width=10cm]{images/game.jpg}};
    \node[rotate=15] at (-8,15) {\includegraphics[width=10cm]{images/solidworks.jpg}};
    \node[rotate=-5] at (1,15) {\includegraphics[height=10cm]{images/touchwiz.jpg}};
    \node[rotate=-25] at (8,10) {\includegraphics[width=10cm]{images/tiger.png}};
    \node[rotate=-15] at (12,2) {\includegraphics[width=8cm]{images/blender.jpg}};
